...
/*!
 ...
 @param eventString         A string describing the action
 @param properties          A dictionary of properties describing the action. Property keys have to be strings, while the values can be strings or numbers.
 */
+ (void) trackEvent:(NSString *) eventString withProperties:(NSDictionary*)properties;
